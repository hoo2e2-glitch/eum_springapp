...
@Component
@Data
@Schema(description = "유저 경험치 지급 이력 VO")
public class UserExpHistoryVO {

    @Schema(description = "경험치 지급 이력 번호", example = "1")
    private Long id;

    @Schema(description = "경험치 지급 타입", example = "POST")
    private String userExpHistoryType;

    @Schema(description = "지급 경험치", example = "5")
    private Long userExpHistoryAmount;

    @Schema(description = "경험치 지급 대상 번호", example = "10")
